...
const PageMegaMenuItem = ({ item }: PageMegaMenuItemProps) => {
  return (
    <li>
      <Link
        href={item.href}
        className="text-secondary/60 dark:text-accent/60 dark:hover:text-accent group/item text-tagline-1 hover:text-secondary flex items-center gap-1   transition-all duration-200">
