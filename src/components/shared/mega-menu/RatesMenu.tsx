...
const RatesMenu = ({ className, isOpen = false, onMouseEnter, onMouseLeave }: RatesMenuProps) => {
  return (
    <div onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
      <div
        ...
        <div className="flex flex-row p-2 overflow-hidden">
          <div className="w-[60%] bg-[#fff] rounded-[13px] p-2 mr-2 bg-[url('/images/shared/dreamy-green.webp')] bg-cover relative overflow-hidden shadow-[inset_0_0_50px_20px_white]">
          ...
          <Image
            src="/images/header/fleet-of-carts.jpeg"
            width={333}
            height={600}
