...
export const VeryLongArrow = ({ className = '' }) => {
  return (
    <svg className={className} data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45.15 12.64">
      <g id="_01_align_center" data-name=" 01 align center">
        <path d="M44.33,4.32l-4.32-4.32-1.33,1.33,4.02,4.02-42.69.03v1.89l42.75-.03-4.07,4.07,1.33,1.33,4.32-4.32c1.1-1.11,1.1-2.89,0-4Z" />
      </g>
    </svg>
  );
};
...
export const ThinArrow = ({ className = '' }) => {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
      <path d="m18.541,10.894l-4.717-4.717-.707.707,4.616,4.617H5v1h12.735l-4.618,4.617.707.707,4.717-4.716c.296-.296.459-.69.459-1.108s-.163-.812-.459-1.106Z" />
    </svg>
