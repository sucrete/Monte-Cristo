...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: 'col3', title: 'Column 3', type: 'text', components: { input: TinyMCEInput } }),
    defineField({ name: 'col4', title: 'Column 4', type: 'text', components: { input: TinyMCEInput } }),
  ],
  preview: {
    prepare() { return { title: '4 Column Layout' } },
  },
})
